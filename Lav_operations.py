...
stop_all_sounds        =  609  # (stop_all_sounds, [options]), 
                               # Apparently exactly what it looks like. Possible options: 0 = let current track finish, 1 = fade it out, 2 = stop it abruptly.
...
agent_deliver_damage_to_agent            = 1722  # (agent_deliver_damage_to_agent, <agent_id_deliverer>, <agent_id>, [damage_amount]),
                                                 # Makes one agent deal damage to another. Damage amount value is optional, if it is skipped or <= 0, then damage will be calculated using attacker's weapon item and stats (like a normal weapon attack).
...
agent_set_attack_action                  = 1745  # (agent_set_attack_action, <agent_id>, <direction_value>, <action_value>),
                                                 # Forces the agent to perform an attack action. Direction value: 0 = thrust, 1 = slashright, 2 = slashleft, 3 = overswing. Action value: 0 = ready and release, 1 = ready and hold.
agent_set_defend_action                  = 1746  # (agent_set_defend_action, <agent_id>, <value>, <duration-in-1/1000-seconds>),
                                                 # Forces the agent to perform a defend action for specified period of time. Possible values: 0 = defend_down, 1 = defend_right, 2 = defend_left, 3 = defend_up.
...
agent_start_running_away                 = 1751  # (agent_start_running_away, <agent_id>),
                                                 # Makes the agent flee the battlefield, ignoring everything else and not attacking. If the agent reaches the edge of map in this mode, he will fade out and become routed.
